# **Tips - Endstone**
适用于[Endstone](https://github.com/EndstoneMC/endstone)的Tips插件，从 [Tips](https://github.com/MemoriesOfTime/Tips) 移植  
目前项目正在开发中，功能仍不完善，请等待后续更新  

#### 使用说明
 1. 将本插件放置到` plugins`文件夹
 2. 自定义样式可参考 **`tips_variables.txt`** 文件（变量说明文档，位于插件数据目录）
 3. 重启服务器即可正常使用
